...
//     version 1.19.0
//     from Assets/Player_InputSystem_Actions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Player_InputSystem_Actions.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @Player_InputSystem_Actions: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @Player_InputSystem_Actions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""Player_InputSystem_Actions"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@Player_InputSystem_Actions()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, Player_InputSystem_Actions.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, Player_InputSystem_Actions.UI.Disable() has not been called.");
    }
    ...
    {
        private @Player_InputSystem_Actions m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@Player_InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@Player_InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
